...
這個專案每天抓取 TrendForce 台灣站「價格趨勢」公開頁面中的報價表，產生每日報告並寄到 `w0617w0617@gmail.com`。
...
GitHub Actions 會在每次成功寄出報告後，把新的歷史資料與 `reports/latest.html`、`reports/latest.md` commit 回 repository。
